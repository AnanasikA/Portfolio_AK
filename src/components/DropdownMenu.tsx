      ...
      {isOpen && (
        <>
          ...
          >
                ...
                >
                  <Link
                    ...
                    style={{
                      ...
                      fontFamily: 'var(--fd)', fontWeight: 600, fontSize: '1.25rem',
            ...
            {/* bottom — tylko przycisk, bez PL/EN (są w headerze) */}
            <div style={{ marginTop: 32, flexShrink: 0 }}>
              <button
                onClick={() => { toggleMenu(); window.dispatchEvent(new Event('open-brief')); }}
                style={{
                  width: '100%',
                  fontFamily: 'var(--fd)', fontWeight: 600, fontSize: '1rem',
                  background: '#fff', color: 'var(--brand)',
                  borderRadius: 99, padding: '.85em 1.5em',
                  border: 'none', cursor: 'pointer',
                }}>
