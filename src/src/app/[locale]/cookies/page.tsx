...
export async function generateMetadata({
  ...
  const title = isEn
    ? 'Cookies Policy | Anastasiia Kupriianets'
    : 'Polityka plików cookies | Anastasiia Kupriianets';
  const description = isEn
    ? 'Information on which cookies are used on anastasiiakupriianets.pl, for what purposes and how you can manage them.'
  ...
  return {
    ...
    alternates: {
      ...
      languages: { pl: '/pl/cookies', en: '/en/cookies', 'x-default': '/pl/cookies' },
    },
